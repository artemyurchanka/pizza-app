...
Веб-приложение личного кабинета для заказа пиццы: меню с поиском по названию и составу, граммовка на карточках, корзина с изменением количества.
...
```
src/
  components/     UI-компоненты (Layout, Heading, Search, ProductCard)
